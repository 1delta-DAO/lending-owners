...
const LENDER_KEY = "DFORCE";

// Messari dForce subgraph deployments (decentralized network).
...
const SUBGRAPH_IDS: Partial<Record<ChainId, string>> = {
  [Chain.ARBITRUM_ONE]: "Dpk4Gen22wxQ3Laojf7DR2me8wGzjaHwjsKAsLf2rCFV",
  [Chain.BNB_SMART_CHAIN_MAINNET]: "DKu1HqTTi26uLZKAmvDbqyAvcnFAjXEuRJmF35RLpyFg",
  [Chain.ETHEREUM_MAINNET]: "6PaB6tKFqrL6YoAELEhFGU6Gc39cEynLbo6ETZMF3sCy",
  [Chain.OP_MAINNET]: "6AmkakXwadWiZ2jN7oJcFreWmKG1nZrT5P8om52upYPd",
  [Chain.POLYGON_MAINNET]: "9CFGPWpntYisBp7NpHMrgYzFrBmtVxSw58haGyZ3ewoZ",
};
...
export interface DForceConfig {
  subgraphApiKey: string;
  side?: PositionSide;
  pageSize?: number;
  /** Minimum owner fraction of market total to include. Defaults to OWNER_FRACTION_BY_LENDER["DFORCE"]. */
