...
// Messari Moonwell subgraph deployments (decentralized network).
...
const SUBGRAPH_IDS: Partial<Record<ChainId, string>> = {
  [Chain.BASE]: "33ex1ExmYQtwGVwri1AP3oMFPGSce6YbocBP7fWbsBrg",
  [Chain.MOONBEAM]: "DQhrdUHwspQf3hSjDtyfS6uqq9YiKoLF3Ut3U9os2HK",
};
...
export interface MoonwellConfig {
  ...
  side?: PositionSide;
  pageSize?: number;
  /** Minimum owner fraction of market total to include. Defaults to OWNER_FRACTION_BY_LENDER["MOONWELL"]. */
...
export function createMoonwellFetcher(config: MoonwellConfig): OwnershipFetcher {
