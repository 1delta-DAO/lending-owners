...
const LENDER_KEY = "SPARK";

// Messari Spark Lend subgraph deployments (decentralized network).
// Spark is an Aave V3 fork — supply-side positions are keyed as "COLLATERAL".
...
const SUBGRAPH_IDS: Partial<Record<ChainId, string>> = {
  [Chain.ETHEREUM_MAINNET]: "GbKdmBe4ycCYCQLQSjqGg6UHYoYfbyJyq5WrG35pv1si",
  [Chain.GNOSIS]: "Bw4RH37UbbGEhHo4FaWwT1dn9QJzm1XSZCyK1cbr6ZKM",
};
...
export interface SparkConfig {
  ...
  side?: PositionSide;
  pageSize?: number;
  /** Minimum owner fraction of market total to include. Defaults to OWNER_FRACTION_BY_LENDER["SPARK"]. */
...
export function createSparkFetcher(config: SparkConfig): OwnershipFetcher {
